...
class AppViewModel(app: Application) : AndroidViewModel(app) {
    ...
    fun previewHealthConnectNutritionRange() = healthConnectCleanupActions.previewRange()
    ...
    fun updateQuickImportParsedFoodGroup(foodIndex: Int, food: QuickImportFood) = quickImportActions.updateParsedFoodGroup(foodIndex, food)
    fun addQuickImportParsedFoodServing(foodIndex: Int) = quickImportActions.addParsedFoodServing(foodIndex)
    fun removeQuickImportParsedFoodServing(foodIndex: Int) = quickImportActions.removeParsedFoodServing(foodIndex)
