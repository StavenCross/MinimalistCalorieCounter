...
data class AppUiState(
    ...
    val healthConnectViewerMealsDate: LocalDate = LocalDateTime.now().minusHours(12).toLocalDate(),
    val healthConnectViewerMealsByDate: Map<LocalDate, List<HealthConnectNutritionMeal>> = emptyMap(),
    val healthConnectViewerMessagesByDate: Map<LocalDate, String?> = emptyMap(),
    val healthConnectViewerLoading: Boolean = false,
    val healthConnectViewerLoadingDate: LocalDate? = null,
    ...
    val healthConnectExportMode: HealthConnectExportMode = HealthConnectExportMode.NutritionAndGoals,
