...
Coverage includes Add Meal parsing, Add Meal planning, Add Meal outbox state/CSV behavior, historical import parsing, and Health Connect historical mapping behavior.
